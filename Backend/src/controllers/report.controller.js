...
now give me the data exactly for the crop not other crop using the output below not of other crop but the spefic crop we have selected and in this specific smaple format we provided note: don't give other the specific crop we put


output
**Output Data (JSON):**

specific format: (only sample) based on this generate it
{
"id": 1749923708298,
"date": "2025-06-14",
"season": "Spring",
